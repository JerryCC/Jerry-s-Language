...
@Reviser public class BasicEvaluator {
	...
	@Reviser public static class ASTListEx extends ASTList {
		...
		public Object eval(Environment env) {
			throw new TLangException("cannot eval: " + toString(), this);
		}
	}
	...
	@Reviser public static class NameEx extends Name {
		...
		public Object eval(Environment env) {
			...
			if (value == null)
				throw new TLangException("undefined name: " + getName(), this);
			else
				return value;
		}
	}
	@Reviser public static class NegativeEx extends NegativeExpr {
		...
		public Object eval(Environment env) {
			...
			if (v instanceof Integer)
				...
				throw new TLangException("bad type for -", this);
		}
	}
	@Reviser public static class BinaryEx extends BinaryExpr {
		...
		protected Object computeAssign(Environment env, Object rvalue) {
			...
			if (l instanceof Name) {
				...
				throw new TLangException("bad assignment", this);
		}
		protected Object computeOp(Object left, String op, Object right) {
			if (left instanceof Integer && right instanceof Integer)
				...
				throw new TLangException("bad type", this);
		}
		protected Object computeNumber(Integer left, String op, Integer right) {
			...
			if (op.equals("+"))
				...
				return a > b ? TRUE : FALSE;
					...
					throw new TLangException("bad operator", this);
